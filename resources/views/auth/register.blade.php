                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="cpfmask" type="text" class="form-control" name="cpf" required autocomplete="cpf">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="telmask" type="text" class="form-control" name="telefone" required autocomplete="telefone">
                            </div>
                        </div>
